...
var secondStartSound = new Audio('sounds/audio_hero_On-The-Ball_SIPML_K-04-25-01.ogg')
secondStartSound.load()
  ...
  document.onkeyup = function (e) {
    switch (e.keyCode) {
      ...
      case 50:
        ...
        if (secondStartSound.paused) {
          secondStartSound.currentTime = 0
          secondStartSound.play()
        } else {
          secondStartSound.pause()
        }
